    ...
    <aside className={`glass-card overflow-hidden flex flex-col ${className}`}>
      ...
      >
          ...
          {items.length > 0 && (
            <div className="flex items-center gap-2">
              ...
              >
                ...
                />
                <span className="text-[11px] text-muted-text select-none">현재 목록 전체 선택</span>
              </label>
              <Button
        ...
        {isLoading ? (
          ...
          <DashboardStateBlock
            title="아직 저장된 분석 기록이 없습니다"
            description="첫 분석을 완료하면 최근 결과가 여기에 표시됩니다."
            icon={(
          ...
          <div className="space-y-2">
            ...
            {!hasMore && items.length > 0 && (
              <div className="text-center py-5">
                ...
                <span className="text-[10px] text-secondary-text uppercase tracking-[0.2em]">목록 끝</span>
              </div>
            )}
          </div>
        )}
