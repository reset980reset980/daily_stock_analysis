...
const HomePage: React.FC = () => {
  ...
  useEffect(() => {
    document.title = 'QuantB - 주식 분석 대시보드';
  }, []);
      ...
      <div className="flex-1 flex flex-col min-h-0 min-w-0 max-w-full lg:max-w-6xl mx-auto w-full">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2.5">
              ...
              <div className="relative min-w-0 flex-1">
                <StockAutocomplete
                  ...
                  placeholder="종목 코드나 이름을 입력하세요. 예: 005930, 삼성전자, AAPL"
        ...
        {setupNeedsAction ? (
          <div className="px-3 pb-2 md:px-4">
            <InlineAlert
              variant="warning"
              title="기본 설정이 아직 완료되지 않았습니다"
              message={
                setupMissingLabels
                  ? `${setupMissingLabels} 설정이 아직 비어 있습니다. 완료하면 바로 기본 분석을 시작할 수 있습니다.`
                  : '필수 기본 설정이 아직 비어 있습니다. 완료하면 바로 분석을 시작할 수 있습니다.'
              }
              action={(
                <Button
                  type="button"
          ...
          <div className="px-3 pb-2 md:px-4">
            <div className="rounded-xl border border-subtle bg-surface/70 px-3 py-3 text-xs text-secondary-text shadow-sm">
              <div className="mb-2 flex items-center justify-between gap-2">
                <p className="font-semibold text-foreground">시장 복기 리포트</p>
                <button
                  type="button"
                ...
                >
                  {marketReviewReportCopied ? '복사 완료' : '복사'}
                </button>
              </div>
          ...
          <section className="flex-1 min-w-0 min-h-0 overflow-x-auto overflow-y-auto px-3 pb-4 md:px-6 touch-pan-y">
            ...
            {isLoadingReport ? (
              ...
              <div className="flex h-full items-center justify-center">
                <EmptyState
                  title="분석 시작하기"
                  description="종목 코드를 입력해 새 분석을 시작하거나, 왼쪽 기록에서 이전 리포트를 선택해 확인하세요."
